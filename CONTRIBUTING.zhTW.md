> This is the Traditional Chinese version. For the canonical English CONTRIBUTING, see [CONTRIBUTING.md](CONTRIBUTING.md).
...
## Maintainer cadence caveat

本專案目前主要由單一作者於教學情境下維護。歡迎外部貢獻，但 review 節奏可能較慢——請耐心等候。
