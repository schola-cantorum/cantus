# cantus-local-llm-and-desktop-walkthrough Specification

## Purpose

TBD - created by archiving change 'cantus-local-llm-and-desktop-walkthrough'. Update Purpose after archive.
