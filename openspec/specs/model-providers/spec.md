...
- **AND** the message names `openai`, `anthropic`, `google`, `groq`, `nvidia`, `ollama`, and `mlx` as the supported prefixes
...
<!-- @trace
source: cantus-local-llm-mlx-path
updated: 2026-06-07
code:
