...
<p align="center">
  ...
  <a href="https://colab.research.google.com/github/schola-cantorum/cantus/blob/v0.6.0/notebooks/task_template.ipynb"><img alt="Open In Colab" src="https://colab.research.google.com/assets/colab-badge.svg"></a>
</p>
...
| --- | --- | --- |
| `notebooks/task_template.ipynb` | End user — build your first agent | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/schola-cantorum/cantus/blob/v0.6.0/notebooks/task_template.ipynb) |
| `notebooks/admin_setup.ipynb` | Administrator — mirror Gemma 4 weights to Drive (run once before downstream users) | [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/schola-cantorum/cantus/blob/v0.6.0/notebooks/admin_setup.ipynb) |
...
- [v0.5.0 → v0.6.0](./docs/migrations/MIGRATION_v0.5.0_to_v0.6.0.md)
